    ...
    public:
        ...
        void operator()(const Range& range) const CV_OVERRIDE
        {
            ...
            for( i = i1; i < i2; i++ )
            {
                ...
                printf("smaller img: %d, %d",smallerImg.rows, smallerImg.cols);
                                              ...
                                              double L2HysThreshold, float sigma, float free_coef, bool signedGradient)
{
    ...
    myclipObjects(imgSize, found_locations, 0, 0);
            ...
            double scale0, double finalThreshold, bool useMeanshiftGrouping) const
    {
        ...
        myclipObjects(imgSize, foundLocations, 0, &foundWeights);
    }
